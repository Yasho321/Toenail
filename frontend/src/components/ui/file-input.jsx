...
const validateFile = (file, accept, maxSizeInMB) => {
  if (accept) {
...
const Idle = ({ accept, maxSizeInMB, onClick, onDrop, error }) => {
  ...
  return (
    <div
      className={cn(
        `h-full w-full backdrop-blur-sm bg-white/5 hover:border-red-600 border-red-600/50 shadow-xl overflow-hidden relative border-[3px] border-dashed rounded-lg flex flex-col items-center justify-center select-none cursor-pointer transition-colors`,
...
const Loading = () => {
  ...
  return (
    <div className="h-full w-full backdrop-blur-sm bg-white/5 hover:border-red-600 border-red-600/50 shadow-xl relative border-[3px] border-zinc-900 rounded-xl flex flex-col items-center justify-center gap-4">
      <div ref={containerRef} className="w-full px-10 flex items-center justify-between relative">
        ...
        >
          <path d={path} stroke="#3F3F47" strokeWidth={1} strokeOpacity={0.8} strokeLinecap="round" />
          <path d={path} strokeWidth={3} stroke={`url(#${'path'})`} strokeOpacity="1" strokeLinecap="round" />
          <defs>
...
const Success = ({ files, onRemove }) => {
  return (
    <div className="h-full w-full backdrop-blur-sm bg-white/5 shadow-xl relative border-[3px] border-zinc-900 rounded-xl flex flex-col items-center justify-center gap-4 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-end p-3 bg-black/20">
          <div className="flex items-end justify-between w-full">
            ...
            <button
              type="button"
              onClick={onRemove}
              className="p-2 rounded-full bg-white/5 group"
            >
              <Trash size={16} className="text-red-600/90" />
            </button>
          </div>
        </div>
      </div>
